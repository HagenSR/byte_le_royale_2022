...
# Placeholder stats
    gun_stats = {
        GunType.none: {'pattern': ShotPattern.none, 'damage': 0,
            'fire_rate': 0, 'cooldown': {'max': 0, 'rate': 0}, 'range': 0,
            'mag_size': 0, 'reload_speed': 0},
        GunType.handgun: {'pattern': ShotPattern.single, 'damage': 1,
            'fire_rate': 2, 'cooldown': {'max': 8, 'rate': 2}, 'range': 30,
            'mag_size': 13, 'reload_speed': 3},
        GunType.assault_rifle: {'pattern': ShotPattern.multi, 'damage': 1,
            'fire_rate': 5, 'cooldown': {'max': 15, 'rate': 5}, 'range': 50,
            'mag_size': 30, 'reload_speed': 6},
        GunType.shotgun: {'pattern': ShotPattern.spread, 'damage': 8,
            'fire_rate': 1, 'cooldown': {'max': 1, 'rate': 1}, 'range': 10,
            'mag_size': 2, 'reload_speed': 8},
        GunType.sniper: {'pattern': ShotPattern.single, 'damage': 9,
            'fire_rate': 1, 'cooldown': {'max': 1, 'rate': 1}, 'range': 100,
