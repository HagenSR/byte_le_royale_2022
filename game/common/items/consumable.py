...
class Consumable(Item):
    def __init__(self, coordinates, hitbox, health, count, spawnable = True, speed_enum = None, health_enum = None, armor_enum = None):
