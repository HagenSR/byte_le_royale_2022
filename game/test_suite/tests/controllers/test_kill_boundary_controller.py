...
class TestKillBoundary(unittest.TestCase):
    ...
    def test_within_radius(self):
        ...
        self.assertEqual(self.player.shooter.health, GameStats.player_stats["starting_health"])

    def test_outside_radius(self):
        self.killBoundaryControl.handle_actions(self.player, 0)
        self.assertEqual(self.player.shooter.health, GameStats.player_stats["starting_health"] - GameStats.circle_damage)
