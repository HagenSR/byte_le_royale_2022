...
class TestGrenade(unittest.TestCase):
    ...
    def test_set_get_fuse_time_boundary_low(self):
        ...
        self.assertEqual(self.grnObj.damage, GameStats.grenade_stats['min_fuse_time'])
     

    def test_set_get_fuse_time_boundary_high(self): 
        self.grnObj.fuse_time = GameStats.grenade_stats['max_fuse_time']
        self.assertEqual(self.grnObj.damage, GameStats.grenade_stats['max_fuse_time'])
       

    def test_grenade_obj_parent_params(self):
      
        testGrn = GrenadeObject(fuse_time = 20, range = 10, damage = 10, heading = 10, speed = 10, health = 1, coordinates=[{'x': 450, 'y': 450}, {'x': 50, 'y': 50}], 
