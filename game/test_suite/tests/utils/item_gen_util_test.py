...
class TestItemGenerationUtil(unittest.TestCase):
    def test_has_reached_item_cap(self):
        ...
        self.assertTrue(has_reached_item_cap(ObjectType.consumable, loot_gen_controller.consumable_count, 0, 0, 0))
    ...
    def test_pick_item(self):
        ...
        picked_items = []
        for i in range(100):
            item = pick_item(xPos,yPos,loot_gen_controller.consumable_count,loot_gen_controller.upgrade_count
                                          ,loot_gen_controller.gun_count,loot_gen_controller.money_count,1)
