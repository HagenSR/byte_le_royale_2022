...
By calling the action 'actions.select_item_to_use(obj)' you can select what item you want to use.
Make sure that obj is the consumable object from your inventory.
